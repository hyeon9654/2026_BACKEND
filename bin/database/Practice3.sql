...
-- [문제 2]
INSERT INTO books
VALUES(1013, '데이터베이스 개론', '이영희', '컴퓨터', 22000, NULL, '2022-09-10');
...
FROM books
WHERE price >= 15000 AND stock >= 10;

-- [문제 14]
SELECT title, genre
FROM books
WHERE genre IN ('컴퓨터', '경제');
...
SELECT title, price
FROM books
WHERE price BETWEEN 14000 AND 18000;
