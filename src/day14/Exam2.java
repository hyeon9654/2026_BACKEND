...
public class Exam2 {
    public static void main(String[] args) {
       ...
       // [3] 리스트/배열과 반복문 관계 // 리스트(목록)내 항목(값)들을 한 번에 꺼내기 없다., 하나씩 꺼내기!
       // 1. 일반 for문
       for( int index = 0; index <= list2.size() - 1; index++ ){
        // index가 0부터 마지막인덱스까지 인덱스 1씩 증가
