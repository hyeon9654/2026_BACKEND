...
public class Exam3 {
    public static void main(String[] args) {
        ...
        System.out.println( new String("유재석").equals("유재석")); // ture

        // 4. 문자열A.concant(문자열B) , 문자열 연결 , 연결된 새로운 문자열 문자열 반환 ( 주소값 생성 )
        String str7 = "자바";        String str8 = "프로그래밍";
        System.out.println( str7.concat(str8)); // 자바프로그래밍 
        System.out.println( str7 + str8 ); // 자바프로그래밍 
        
        // 5. StringBuilder . append( ) , 문자열(리터럴)은 불변(수정금지)이다. , 빌더주소값 1개 지정하여 새로운
        ...
        // 9. 
        String str10 = "020811-1237856";
        System.out.println( str10.substring(6)); // -1237856
        System.out.println( str10.substring(0,6)); // 0부터 6전까지 , 020811

        // 10. .split( 기준문자 ) , 기준문자 기준으로 문자열 분해
        System.out.println( str10.split("-"));  // [Ljava.lang.String;@3a71f4dd
        String[ ] strAry = str10.split("-");
        System.out.println( strAry[0]); // 020811
        System.out.println( strAry[1]); // 1237856
