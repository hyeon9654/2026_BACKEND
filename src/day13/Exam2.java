...
public class Exam2 {
    public static void main(String[] args) {
        ...
        Integer value4 = value1;    // int(기본) --> Interger(참조) 변환 < 오토박싱 >
        ...
        System.out.println( localTime );    // 11:09:14.349216

        // 3. 현재 날짜/시간 가져오기
        LocalDateTime localDateTime = LocalDateTime.now();
        System.out.println( localDateTime );// 2026-08-19T11:09:14.350231900

        // 4. 정해진 날짜시간 객체 생성 LocalDateTime.of( 연도,월,일,시,분,초 ) : 오버로딩(매개변수에 따른 메소드 여러개)
