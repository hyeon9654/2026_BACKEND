...
public class Exam1 {
    public static void main(String[] args) {
        ...
        // 가능한 이유 : 1) 상속관계(논리) 2) 참새인스턴스가 생성될때 + 조류 + 동물  인스턴스 생성
        조류 bird2 = sparrow1; 
        // 2. 참새 타입 예시 동물 타입으로 될까?
        동물 animal2 = sparrow1;    // 업캐스팅
        // 3. 동물 타입에서 참새 타입으로 될까? 주의!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        // 주의할점 : 1) 변환타입명시   2) 변환할 자료가 변환할 타입 포함하는지?
