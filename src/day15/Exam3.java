...
import java.awt.*; // java 내 UI 제공 = awt/fx
    ...
    public static void main(String[] args) {
        /* 프로그램: 실행 가능한 코드들의 집합
           ...
           멀티 태스킹: 두 가지 이상의 작업을 동시에 처리
                ...
                - *멀티 스레드: 하나의 프로레스내 여러개 흐름 작업 실행하는 구조 
            스레드란? 하나의 프로세스내 최소 작업 단위 또는 실행 흐름 단위
                - CPU가 ( <--운영체제--> ) 프로세스내 스레드를 통해 코드를 순차적으로 처리
            main함수란? JAVA내 단일 스레드 환경 main메소드가 제공한다.
            멀티스레드 구현
        ...
        */
        ...
        Thread thread1 = new Thread( runnable ); // new Thread( 익ㄱ명구현체 );
